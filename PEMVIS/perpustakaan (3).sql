...
--
-- Host: localhost:3306
-- Generation Time: Dec 27, 2025 at 03:13 PM
...
INSERT INTO `detail_peminjaman` (`id_detail`, `id_peminjaman`, `id_buku`, `nama_buku`, `penerbit`, `tahun_terbit`, `tebal_buku`, `status`) VALUES
('PMJ0001-DT001', 'PMJ0001', 'buku2', 'Nyali untuk beristri 4', 'Kurnia Setiawan', '2004', '20', 'Dikembalikan'),
('PMJ0002-DT001', 'PMJ0002', 'MDLG1', 'Madilog', 'Tan Malaka', '1960', '120', 'Dipinjam'),
('PMJ0003-DT001', 'PMJ0003', 'buku2', 'Nyali untuk beristri 4', 'Kurnia Setiawan', '2004', '20', 'Dikembalikan'),
('PMJ0004-DT001', 'PMJ0004', 'buku2', 'Nyali untuk beristri 4', 'Kurnia Setiawan', '2004', '20', 'Dipinjam'),
('PMJ0005-DT001', 'PMJ0005', 'buku2', 'Nyali untuk beristri 4', 'Kurnia Setiawan', '2004', '20', 'Dipinjam'),
('PMJ0005-DT002', 'PMJ0005', 'MDLG1', 'Madilog', 'Tan Malaka', '1960', '120', 'Dipinjam');
...
('IN0001-DT001', 'IN0001', 'buku2', 'Nyali untuk beristri 4', 'hilang', 'hilang jir', 356000);
...
('PMJ0001', '2025-12-22', '20211', 'kurnia', 'r6s', '0895', '2026-01-21'),
('PMJ0002', '2025-12-22', '1733', 'Dennis Abizar', 'R6S', '08121213', '2026-01-21'),
('PMJ0003', '2025-12-22', '1733', 'Dennis Abizar', 'R6S', '08121213', '2026-01-21'),
('PMJ0004', '2025-12-22', '1733', 'Dennis Abizar', 'R6S', '08121213', '2026-01-21'),
('PMJ0005', '2025-12-23', '1733', 'Dennis Abizar', 'R6S', '08121213', '2026-01-22');
...
CREATE TABLE `pengembalian` (
  `id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `id_peminjaman` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `pengembalian` (`id`, `id_peminjaman`, `id_siswa`, `nama_siswa`, `tgl_pinjam`, `tgl_kembali`, `total_denda`) VALUES
('IN0001', 'PMJ0003', '1733', 'Dennis Abizar', '2025-12-22', '2026-12-31', 0);
...
--
ALTER TABLE `pengembalian`
  ADD CONSTRAINT `pengembalian_ibfk_1` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjaman` (`id_peminjaman`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
