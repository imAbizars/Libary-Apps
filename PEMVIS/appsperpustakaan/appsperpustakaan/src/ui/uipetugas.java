...
public class uipetugas extends javax.swing.JPanel {
private Connection conn = new koneksi().connect();
private DefaultTableModel tabmode;
private uilogin formLogin;
    
    public uipetugas() {
        initComponents();
        formLogin = new uilogin();
        kosong();
        aktif();
        datatable();
        loaddata();
    ...
    protected void datatable(){
        ...
        Object [] Baris ={"ID PETUGAS","NAMA","USERNAME","PASSWORD","JENIS KELAMIN","ALAMAT"};
        tabmode = new DefaultTableModel(null,Baris);
        String cariitem=txtcari.getText();
        
        try{
            String sql = "SELECT * FROM datapetugas where id_petugas like '%"+cariitem+"%' or nm_petugas like '%"+cariitem+"%' order by id_petugas asc";
    ...
    private void initComponents() {
        ...
        txtusername = new tools.JTextFieldRounded();
        jLabel5 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        rlaki = new javax.swing.JRadioButton();
        jLabel7 = new javax.swing.JLabel();
        txtpassword = new tools.JTextFieldRounded();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-admin-30 (1).png"))); // NOI18N
        ...
        txtusername.setCornerRadius(10);
        txtusername.setFont(new java.awt.Font("Poppins Medium", 2, 12)); // NOI18N
        ...
        txtpassword.setCornerRadius(10);
        txtpassword.setFont(new java.awt.Font("Poppins Medium", 2, 12)); // NOI18N
        ...
        pn_addLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pn_addLayout.createSequentialGroup()
                ...
                .addGroup(pn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtpassword, javax.swing.GroupLayout.PREFERRED_SIZE, 990, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7)
                    .addComponent(jLabel6)
                    .addComponent(jLabel3)
                    .addComponent(jLabel4)
                    .addGroup(pn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txtusername, javax.swing.GroupLayout.PREFERRED_SIZE, 990, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void insertData(){
     String jenis = null;
        ...
        try {
           ...
           stat.setString(4,formLogin.getMd5java(txtpassword.getText()));
    ...
    private void bhapusviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusviewActionPerformed
        ...
        if (ok==0){
            String sql = "delete from datapetugas where id_petugas ='"+txtid.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private tools.JTextFieldRounded txtpassword;
    private tools.JTextFieldRounded txtusername;
    ...
    private void updateData() {
       String jenis = null;
        ...
        String sql = "update datapetugas set nm_petugas=?,username=?,password=?,jenis=?,alamat=? where id_petugas='"+txtid.getText()+"'";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1,txtnm.getText());
            stat.setString(2,txtusername.getText());
            stat.setString(3,formLogin.getMd5java(txtpassword.getText()));
